...
import (
	...
	agentintegration "kkg-backend/internal/oj/integration/agent"
	blogintegration "kkg-backend/internal/oj/integration/blog"
...
func parseAgentReply(reply string, questionTitle string) (title, summary, markdown, code string) {
	...
	if err := json.Unmarshal([]byte(extractAgentJSON(reply)), &obj); err == nil {
...
func extractAgentJSON(reply string) string {
